...
class UrlBuilder {
    ...
    private static final String BASIC_JOB_INFO = "name,url,color,inQueue,healthReport[description,iconUrl],lastBuild[url,building,result,number],property[parameterDefinitions[name,type,defaultParameterValue[value],choices]]";
